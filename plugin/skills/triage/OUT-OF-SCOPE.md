...
During triage (the "Gather context" step), read all files in `.out-of-scope/`. When evaluating a new ticket:
...
5. Comment on the ticket explaining the decision and mentioning the `.out-of-scope/` file (don't forget the AI-during-triage disclaimer prefix)
6. Close the ticket and apply the `wontfix` triage label
